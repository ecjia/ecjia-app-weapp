                            ...
                            <div class="form-group row">
                                <div class="col-lg-12 controls material-table">
                                    ...
                                    <div class="text m_b10">
                                        ...
                                        <div class="js_appmsgArea" {if $subscribe.reply_type neq
                                        'text'}style="display: block;"{/if}>
                                        <div class="tab_cont_cover create-type__list" {if $subscribe.id}style="display: none;" {
                                        /if}>
