...
<div class="row">
    <div class="col-12">
        <div class="card">
            ...
            <div class="card-body">
            	<div>
            		<button type="button" class="ajaxmenu btn btn-outline-primary" data-url='{RC_Uri::url("weapp/platform_record/get_customer_record")}' data-value="get_record">
			...
			<div class="card-header">
     		...
     		<div class="card-body">
     			<ul class="nav nav-pills float-left">
     				<li class="nav-item">
						<a class="nav-link data-pjax {if $list.filter.status eq 1}active{/if}" href='{url path="weapp/platform_record/init" args="
            ...
            <div class="col-md-12">
				<table class="table table-hide-edit">
					...
					<tbody>
						...
						<tr>
							<td class="big">
								<a tabindex="0" class="user_info" title="{lang key='wechat::wechat.detail_info'}" data-toggle="popover" data-uid="{$val.uid}" data-trigger="focus" data-url='{RC_Uri::url("weapp/platform_record/get_user_info", "uid={$val.uid}")}'>
							...
							<td class="hide-edit-area">	
								...
								<div class="edit-list">
									<a class="data-pjax" href='{RC_Uri::url("weapp/platform_record/record_message", "uid={$val.uid}&status={$list.filter.status}{if $smarty.get.kf_account}&kf_account={$smarty.get.kf_account}{/if}{if $smarty.get.page}&page={$smarty.get.page}{/if}")}' title="{lang key='system::system.view'}">{lang key='system::system.view'}</a>
								</div>
							</td>
						</tr>
						<!--  {foreachelse} -->
