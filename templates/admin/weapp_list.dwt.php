    ...
    <form method="post" action="{$search_action}" name="searchForm">
        <div class="btn-group f_l m_r5">
            ...
            <ul class="dropdown-menu">
                <li>
                    <a class="button_remove" data-toggle="ecjiabatch" data-idClass=".checkbox:checked" data-url='{url path="weapp/admin/batch_remove"}' data-msg="{lang key='weapp::weapp.sure_want_do'}" data-noSelectMsg="{lang key='weapp::weapp.delete_selected_plat'}" data-name="id" href="javascript:;"><i class="fontello-icon-trash"></i>{lang key='weapp::weapp.weapp_delete'}</a>
                </li>
            </ul>
        </div>
        ...
        <table class="table table-striped smpl_tbl table-hide-edit">
            ...
            <tbody>
                ...
                <tr class="big">
                    ...
                    <td>
                        <span class="cursor_pointer" data-trigger="editable" data-url="{RC_Uri::url('weapp/admin/edit_sort')}" data-name="sort" data-pk="{$val.id}" data-title="{lang key='weapp::weapp.edit_weapp_sort'}">{$val.sort}</span>
                    </td>
                    <td>{$val.add_time}</td>
                </tr>
                <!--  {foreachelse} -->
