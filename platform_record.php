...
class platform_record extends ecjia_platform
{
    public function __construct()
    {
        ...
        RC_Script::enqueue_script('admin_record', RC_App::apps_url('statics/platform-js/platform_record.js', __FILE__));
        ...
        ecjia_platform_screen::get_current_screen()->add_nav_here(new admin_nav_here(RC_Lang::get('wechat::wechat.customer_chat_record'), RC_Uri::url('weapp/platform_record/init')));
    ...
    {
        $this->admin_priv('weapp_record_manage');
        ...
        if (is_ecjia_error($wechat_id)) {
            ...
            $this->assign('action', RC_Uri::url('weapp/platform_record/init'));
        ...
        $this->display('weapp_record_list.dwt');
    }
    ...
    public function record_message()
    {
        ...
        $this->assign('action_link', array('text' => RC_Lang::get('wechat::wechat.customer_chat_record'), 'href' => RC_Uri::url('weapp/platform_record/init', array('status' => $status, 'kf_account' => $kf_account, 'page' => $page))));
        $this->assign('chat_action', RC_Uri::url('weapp/platform_record/send_message'));
        $this->assign('last_action', RC_Uri::url('weapp/platform_record/read_message'));
        ...
        $this->display('weapp_record_message.dwt');
    }
        ...
        try {
            ...
            if ($list['number'] > 0) {
                ...
                if ($start_time < SYS_TIME && SYS_TIME < $end_time) {
                    return $this->showmessage('当前没有更多数据', ecjia::MSGTYPE_JSON | ecjia::MSGSTAT_SUCCESS, array('pjaxurl' => RC_Uri::url('weapp/platform_record/init')));
                }
            ...
            return $this->showmessage('获取完成', ecjia::MSGTYPE_JSON | ecjia::MSGSTAT_SUCCESS, array('pjaxurl' => RC_Uri::url('weapp/platform_record/init')));
